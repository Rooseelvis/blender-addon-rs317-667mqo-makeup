...
def duplicate_shared_materials(obj):
    """Duplicate materials that are shared between selected and non-selected faces"""
    if obj.mode != 'EDIT':
        return
...
def refresh_materials(context):
    ...
    for obj in selected_objs:
        ...
        # Duplicate shared materials in edit mode to prevent affecting unselected faces
...
class AETHER_OT_RandomizeTheme(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        # Base atmosphere controls
        props.shadows_value = random.uniform(-0.2, 0.4)
        props.brightness_value = random.uniform(1.1, 1.8)
        props.contrast_value = random.uniform(1.05, 1.3)
        props.warmth_value = random.uniform(-0.5, 0.7)
        props.tint_value = random.uniform(-0.25, 0.25)
        props.vibrance_value = random.uniform(0.25, 0.5)

        # Occasional color rotation for wild effects
        if random.random() < 0.2:
            props.color_rotation_value = random.uniform(-0.4, 0.4)

        # Choose theme
        themes = ['red', 'orange', 'yellow', 'green', 'cyan', 'blue', 'purple', 'pink', 'monochrome', 'wild']
        theme = random.choice(themes)

        if theme == 'red':
            props.r_value = random.uniform(1.8, 2.5)
            props.g_value = random.uniform(0.6, 1.1)
            props.b_value = random.uniform(0.6, 1.1)
            props.hue_value = random.uniform(-0.03, 0.03)
            props.saturation_value = random.uniform(1.5, 2.0)
            props.value_value = random.uniform(1.0, 1.4)
            props.warmth_value += random.uniform(0.2, 0.5)

        elif theme == 'orange':
            props.r_value = random.uniform(1.8, 2.5)
            props.g_value = random.uniform(1.2, 1.9)
            props.b_value = random.uniform(0.6, 1.0)
            props.hue_value = random.uniform(0.05, 0.12)
            props.saturation_value = random.uniform(1.4, 1.9)
            props.value_value = random.uniform(1.1, 1.5)
            props.warmth_value += random.uniform(0.3, 0.7)

        elif theme == 'yellow':
            props.r_value = random.uniform(1.6, 2.3)
            props.g_value = random.uniform(1.6, 2.3)
            props.b_value = random.uniform(0.6, 1.1)
            props.hue_value = random.uniform(0.08, 0.16)
            props.saturation_value = random.uniform(1.4, 2.0)
            props.value_value = random.uniform(1.2, 1.8)
            props.warmth_value += random.uniform(0.4, 0.8)

        elif theme == 'green':
            props.r_value = random.uniform(0.6, 1.1)
            props.g_value = random.uniform(1.7, 2.5)
            props.b_value = random.uniform(0.7, 1.3)
            props.hue_value = random.uniform(0.25, 0.40)
            props.saturation_value = random.uniform(1.3, 1.9)
            props.value_value = random.uniform(1.1, 1.6)
            props.tint_value += random.uniform(0.1, 0.3)

        elif theme == 'cyan':
            props.r_value = random.uniform(0.6, 1.1)
            props.g_value = random.uniform(1.6, 2.4)
            props.b_value = random.uniform(1.6, 2.4)
            props.hue_value = random.uniform(0.47, 0.56)
            props.saturation_value = random.uniform(1.4, 2.0)
            props.value_value = random.uniform(1.2, 1.7)
            props.warmth_value -= random.uniform(0.2, 0.4)

        elif theme == 'blue':
            props.r_value = random.uniform(0.6, 1.0)
            props.g_value = random.uniform(0.7, 1.2)
            props.b_value = random.uniform(1.8, 2.5)
            props.hue_value = random.uniform(0.60, 0.73)
            props.saturation_value = random.uniform(1.3, 1.9)
            props.value_value = random.uniform(1.0, 1.5)
            props.warmth_value -= random.uniform(0.3, 0.6)

        elif theme == 'purple':
            props.r_value = random.uniform(1.5, 2.3)
            props.g_value = random.uniform(0.6, 1.1)
            props.b_value = random.uniform(1.6, 2.4)
            props.hue_value = random.uniform(0.77, 0.92)
            props.saturation_value = random.uniform(1.4, 2.0)
            props.value_value = random.uniform(1.1, 1.6)
            props.tint_value += random.uniform(0.1, 0.3)

        elif theme == 'pink':
            props.r_value = random.uniform(1.7, 2.5)
            props.g_value = random.uniform(0.7, 1.3)
            props.b_value = random.uniform(1.4, 2.2)
            props.hue_value = random.uniform(-0.05, 0.02)
            props.saturation_value = random.uniform(1.3, 1.9)
            props.value_value = random.uniform(1.2, 1.7)
            props.warmth_value += random.uniform(0.1, 0.4)

        elif theme == 'monochrome':
            # Monochrome with slight color bias
            base_val = random.uniform(0.9, 1.5)
            variation = random.uniform(0.05, 0.15)
            props.r_value = base_val + random.uniform(-variation, variation)
            props.g_value = base_val + random.uniform(-variation, variation)
            props.b_value = base_val + random.uniform(-variation, variation)
            props.hue_value = random.uniform(-0.05, 0.05)
            props.saturation_value = random.uniform(0.4, 0.8)
            props.value_value = random.uniform(1.2, 1.9)
            props.vibrance_value = random.uniform(-0.3, 0.0)

        elif theme == 'wild':
            # Wild multi-color
            props.r_value = random.uniform(0.7, 2.5)
            props.g_value = random.uniform(0.7, 2.5)
            props.b_value = random.uniform(0.7, 2.5)
            props.hue_value = random.uniform(-0.3, 0.3)
            props.saturation_value = random.uniform(1.0, 2.0)
            props.value_value = random.uniform(0.9, 1.7)
            props.color_rotation_value = random.uniform(-0.5, 0.5)
            props.vibrance_value = random.uniform(0.3, 0.5)
...
PRESETS = {
    "Crimson": {"r": 1.6, "g": 0.7, "b": 0.7, "h": 0.0, "s": 1.3, "v": 1.0, "brightness": 1.0, "contrast": 1.1, "warmth": 0.3, "tint": 0.0, "vibrance": 0.2, "rotation": 0.0, "shadows": 0.0},
    "Ruby": {"r": 2.50, "g": 0.00, "b": 0.00, "h": -0.06, "s": 1.77, "v": 0.90, "brightness": 2.00, "contrast": 1.25, "warmth": 0.24, "tint": -0.04, "vibrance": -0.21, "rotation": 0.0, "shadows": 0.0},
    "Wine": {"r": 1.5, "g": 0.7, "b": 1.1, "h": 0.03, "s": 1.3, "v": 1.0, "brightness": 1.0, "contrast": 1.15, "warmth": 0.25, "tint": 0.15, "vibrance": 0.15, "rotation": 0.0, "shadows": 0.0},
    "Tangerine": {"r": 1.7, "g": 1.1, "b": 0.6, "h": 0.07, "s": 1.4, "v": 1.1, "brightness": 1.1, "contrast": 1.0, "warmth": 0.45, "tint": 0.0, "vibrance": 0.15, "rotation": 0.0, "shadows": 0.0},
    "Gold": {"r": 1.60, "g": 1.40, "b": 0.60, "h": 0.12, "s": 1.30, "v": 2.00, "brightness": 2.00, "contrast": 0.85, "warmth": 0.32, "tint": 0.00, "vibrance": 0.10, "rotation": 0.0, "shadows": 0.0},
    "Bronze": {"r": 1.4, "g": 1.0, "b": 0.7, "h": 0.10, "s": 1.2, "v": 1.0, "brightness": 1.0, "contrast": 1.1, "warmth": 0.35, "tint": 0.0, "vibrance": 0.15, "rotation": 0.0, "shadows": 0.0},
    "Emerald": {"r": 2.50, "g": 2.50, "b": 0.00, "h": 0.25, "s": 1.30, "v": 1.56, "brightness": 1.25, "contrast": 1.03, "warmth": -0.14, "tint": 0.32, "vibrance": -0.10, "rotation": 0.0, "shadows": 0.0},
    "Jade": {"r": 0.8, "g": 1.5, "b": 1.0, "h": 0.28, "s": 1.2, "v": 1.0, "brightness": 1.0, "contrast": 1.05, "warmth": -0.15, "tint": 0.0, "vibrance": 0.2, "rotation": 0.0, "shadows": 0.0},
    "Lime": {"r": 0.78, "g": 2.50, "b": 0.00, "h": 0.20, "s": 1.40, "v": 2.00, "brightness": 2.00, "contrast": 0.93, "warmth": -0.07, "tint": 0.06, "vibrance": 0.50, "rotation": 0.0, "shadows": 0.0},
    "Forest": {"r": 0.7, "g": 1.4, "b": 0.75, "h": 0.33, "s": 1.25, "v": 1.05, "brightness": 1.05, "contrast": 1.15, "warmth": 0.05, "tint": 0.0, "vibrance": 0.2, "rotation": 0.0, "shadows": 0.0},
    "Cyan": {"r": 2.50, "g": 2.50, "b": 2.50, "h": 0.50, "s": 1.40, "v": 2.00, "brightness": 1.15, "contrast": 1.00, "warmth": -0.30, "tint": 0.00, "vibrance": 0.25, "rotation": 0.0, "shadows": 0.0},
    "Turquoise": {"r": 0.8, "g": 1.4, "b": 1.4, "h": 0.45, "s": 1.3, "v": 1.1, "brightness": 1.05, "contrast": 1.05, "warmth": -0.25, "tint": 0.0, "vibrance": 0.2, "rotation": 0.0, "shadows": 0.0},
    "Sapphire": {"r": 2.50, "g": 0.00, "b": 2.47, "h": 0.50, "s": 1.30, "v": 1.05, "brightness": 2.00, "contrast": 0.98, "warmth": -1.00, "tint": 0.00, "vibrance": 0.20, "rotation": 0.0, "shadows": 0.0},
    "Cobalt": {"r": 0.7, "g": 1.0, "b": 1.5, "h": 0.60, "s": 1.2, "v": 1.0, "brightness": 1.0, "contrast": 1.05, "warmth": -0.35, "tint": 0.0, "vibrance": 0.15, "rotation": 0.0, "shadows": 0.0},
    "Navy": {"r": 0.8, "g": 0.95, "b": 1.5, "h": 0.64, "s": 1.2, "v": 1.0, "brightness": 1.0, "contrast": 1.1, "warmth": -0.35, "tint": 0.0, "vibrance": 0.2, "rotation": 0.0, "shadows": 0.0},
    "Amethyst": {"r": 1.2, "g": 0.7, "b": 1.5, "h": 0.78, "s": 1.2, "v": 1.05, "brightness": 1.05, "contrast": 1.05, "warmth": 0.05, "tint": 0.2, "vibrance": 0.25, "rotation": 0.0, "shadows": 0.0},
    "Violet": {"r": 2.50, "g": 2.50, "b": 0.00, "h": -0.26, "s": 2.00, "v": 2.00, "brightness": 2.00, "contrast": 1.06, "warmth": 0.03, "tint": 0.07, "vibrance": 0.50, "rotation": 0.0, "shadows": 0.0},
    "Magenta": {"r": 1.5, "g": 0.7, "b": 1.3, "h": 0.90, "s": 1.4, "v": 1.1, "brightness": 1.1, "contrast": 1.05, "warmth": 0.1, "tint": 0.3, "vibrance": 0.3, "rotation": 0.0, "shadows": 0.0},
    "Pink": {"r": 2.50, "g": 0.04, "b": 2.50, "h": -0.08, "s": 2.00, "v": 2.00, "brightness": 2.00, "contrast": 1.10, "warmth": -0.11, "tint": 0.20, "vibrance": 0.20, "rotation": 0.0, "shadows": 0.0},
    "Silver": {"r": 1.20, "g": 0.00, "b": 1.20, "h": -0.50, "s": 0.40, "v": 2.00, "brightness": 2.00, "contrast": 0.84, "warmth": 0.00, "tint": 0.00, "vibrance": -0.20, "rotation": 0.0, "shadows": 0.0},
    "Platinum": {"r": 2.50, "g": 0.00, "b": 0.00, "h": 0.50, "s": 0.29, "v": 2.00, "brightness": 1.75, "contrast": 0.71, "warmth": -0.10, "tint": 0.00, "vibrance": -0.47, "rotation": 0.0, "shadows": 0.0},
    "Obsidian": {"r": 1.1, "g": 1.0, "b": 1.2, "h": 0.75, "s": 0.8, "v": 0.9, "brightness": 0.9, "contrast": 1.25, "warmth": -0.2, "tint": 0.1, "vibrance": 0.1, "rotation": 0.0, "shadows": 0.0},
    "Shadow": {"r": 2.50, "g": 0.00, "b": 0.00, "h": 0.50, "s": 1.30, "v": 1.89, "brightness": 0.81, "contrast": 1.15, "warmth": -0.44, "tint": 0.32, "vibrance": 0.25, "rotation": 0.0, "shadows": 0.0},
    "Arcane": {"r": 2.50, "g": 0.00, "b": 0.00, "h": 0.50, "s": 0.00, "v": 1.71, "brightness": 2.00, "contrast": 1.35, "warmth": -0.18, "tint": -0.07, "vibrance": 0.43, "rotation": 0.0, "shadows": 0.0},
    "OSRS Phat Red": {"r": 2.2, "g": 0.4, "b": 0.4, "h": 0.0, "s": 1.8, "v": 0.7, "brightness": 0.8, "contrast": 1.2, "warmth": 0.4, "tint": 0.0, "vibrance": 0.3, "rotation": 0.0, "shadows": 0.0},
    "OSRS Phat Yellow": {"r": 1.8, "g": 2.0, "b": 0.3, "h": 0.09, "s": 1.8, "v": 1.5, "brightness": 1.5, "contrast": 1.0, "warmth": 0.6, "tint": 0.0, "vibrance": 0.4, "rotation": 0.0, "shadows": 0.0},
    "OSRS Phat Green": {"r": 0.4, "g": 2.2, "b": 0.4, "h": 0.33, "s": 1.8, "v": 1.4, "brightness": 1.4, "contrast": 1.1, "warmth": 0.0, "tint": 0.0, "vibrance": 0.4, "rotation": 0.0, "shadows": 0.0},
    "OSRS Phat Blue": {"r": 0.3, "g": 0.3, "b": 2.2, "h": 0.66, "s": 1.7, "v": 0.9, "brightness": 0.9, "contrast": 1.2, "warmth": -0.5, "tint": 0.0, "vibrance": 0.3, "rotation": 0.0, "shadows": 0.0},
    "OSRS Phat Purple": {"r": 1.5, "g": 0.4, "b": 2.0, "h": 0.80, "s": 1.8, "v": 1.3, "brightness": 1.3, "contrast": 1.1, "warmth": 0.1, "tint": 0.2, "vibrance": 0.4, "rotation": 0.0, "shadows": 0.0},
}
